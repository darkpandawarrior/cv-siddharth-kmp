    ...
    listOf(
        ...
        Experience(
            ...
            points =
                listOf(
                    ExperiencePoint(
                        """Owned Android development across multi-tenant SaaS platforms for customer, driver, and merchant apps.""",
                    ),
                    ExperiencePoint("""Built modular white-label templates, cutting delivery time 80% across 20+ clients."""),
                    ExperiencePoint(
                        """Refactored core modules and REST integrations (Retrofit, OkHttp), including secure payment gateways.""",
                    ),
        ...
        SkillGroup(
            ...
            items =
                listOf(
                    ...
                    "Room (SQLite, 24 migrations · 2 DBs)",
        ...
        SkillGroup(
            ...
            items =
                listOf(
                    ...
                    "Foreground services",
                    "Hilt / Dagger",
                    "Firebase Crashlytics + Sentry + Mixpanel",
                ),
        ),
        SkillGroup(
            group = "Security & Ops",
...
val resumeSkills =
    listOf(
        ...
        SkillGroup(
            ...
            items =
                listOf(
                    "Room (SQLite, 24 schema migrations across 2 databases)",
                    "DataStore",
                    "Retrofit",
                    "OkHttp",
                    "Ktor",
        ...
        SkillGroup(
            ...
            items =
                listOf(
                    ...
                    "WorkManager",
                    "Foreground Services",
                    "Location / dead reckoning + Kalman filtering",
        ...
        SkillGroup(
            ...
            items =
                listOf(
                    ...
                    "Figma",
                    "Postman",
                    "Firebender + MCP agentic workflows",
                ),
        ),
    )
...
val openSource =
    listOf(
        Contribution(
            "santifer/career-ops",
            "feat(agent-inbox): queue requests for the next session",
            "https://github.com/santifer/career-ops/pull/1472",
            "merged",
            "2026-07-03",
        ),
        Contribution(
            "santifer/career-ops",
            "fix(dashboard): rewrite only the Status cell on status update",
            "https://github.com/santifer/career-ops/pull/1186",
            "merged",
            "2026-06-23",
        ),
        Contribution(
            ...
            "https://github.com/santifer/career-ops/pull/1185",
            "merged",
            "2026-06-23",
        ),
        Contribution(
            "santifer/career-ops",
            "feat(providers): add BambooHR provider",
            "https://github.com/santifer/career-ops/pull/1141",
            "merged",
            "2026-06-20",
        ),
    )
